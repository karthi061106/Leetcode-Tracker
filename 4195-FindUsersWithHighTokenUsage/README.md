...
**Difficulty:** Easy  
[View on LeetCode](https://leetcode.com/problems/find-users-with-high-token-usage/)
...
- Total prompts = 3 - Average tokens = (120 + 80 + 200) / 3 = 133.33 - Has a prompt with 200 tokens, which is greater than the average - Included in the result

- **User 2**: - Total prompts = 2 (less than the required minimum) - Excluded from the result

- **User 3**: - Total prompts = 4 - Average tokens = (300 + 250 + 180 + 220) / 4 = 237.5 - Has prompts with 300 and 250 tokens, both greater than the average - Included in the result
