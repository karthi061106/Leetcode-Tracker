...
**Difficulty:** Medium  
[View on LeetCode](https://leetcode.com/problems/find-emotionally-consistent-users/)
...
- Total reactions = 5 - like appears 4 times - reaction_ratio = 4 / 5 = 0.80 - Meets the 60% consistency requirement

- **User 2**: - Total reactions = 5 - Most frequent reaction appears only 2 times - reaction_ratio = 2 / 5 = 0.40 - Does not meet the consistency requirement

- **User 3**: - Total reactions = 5 - 'love' appears 5 times - reaction_ratio = 5 / 5 = 1.00 - Meets the consistency requirement
