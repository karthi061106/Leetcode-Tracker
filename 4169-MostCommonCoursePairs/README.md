...
**Difficulty:** Hard  
[View on LeetCode](https://leetcode.com/problems/most-common-course-pairs/)
...
- Find all **consecutive course pairs** (`Course A &rarr; Course B`) taken by these students.
...
- User 1: Python Basics &rarr; SQL Fundamentals &rarr; JavaScript &rarr; React Basics &rarr; Node.js &rarr; Docker - User 2: Python Basics &rarr; React Basics &rarr; Node.js &rarr; Docker &rarr; AWS Fundamentals - Most common transitions: Node.js &rarr; Docker (2 times), React Basics &rarr; Node.js (2 times)
